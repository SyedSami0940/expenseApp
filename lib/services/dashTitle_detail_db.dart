...
class DatabaseService {
  ...
  Future<void> updateTitle(String id, DashTitleDetail updatedDetails) async {
    await FirebaseFirestore.instance
        .collection(
            'DASHBOARD_TITLE_COLLECTION') // Replace with your collection
        .doc(id)
        .update(updatedDetails.toJson());
  }
  // edit
  // Future<void> updateTitle(
  //     String titleId, DashTitleDetail updatedDetails) async {
  //   try {
  //     await _firestore
  //         .collection(DASHBOARD_TITLE_COLLECTION)
  //         .doc(titleId)
  //         .set(updatedDetails.toJson());
  //   } catch (e) {
  //     rethrow;
  //   }
  // }
